    ...
    <div class="container py-5">
        <div class="row justify-content-start">
            <div class="col-lg-8 text-center text-lg-start">
                <h1 class="display-1 text-uppercase text-white mb-4">Bienvenu(e)</h1>
                <h1 class="display-1 text-uppercase text-white mb-4">Chez Zepneus.com</h1>
                <h1 class="text-uppercase text-white">Les meilleures sont disponible pour vous.</h1>
                <div class="d-flex align-items-center justify-content-center justify-content-lg-start pt-5">
                    <a href="/a-propos" class="btn btn-primary border-inner py-3 px-5 me-5">Qui sommes-nous ?</a>
                </div>
            </div>
        </div>
    </div>
